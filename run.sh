export PROJECT_HOME="/ds1/pdi/vtop/HRIT/cb_locations/cb_locations/PDI/Common"
...
export LOG_DIR="/ds1/pdi/data/CB/log/cb_locations"
...
log_ext='.log'
log_file=${LOG_DIR}/$file_folder_name/'cb_locations-'$log_date$log_ext
...
if  [ $ce -gt 0 ]; then
  ...
  } | mailx -s $host_name' - CB cb_locations PDI Process - ' -r noreply@kuehne-nagel.com amer.hrit.support@kuehne-nagel.com
fi